...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/project/Lifespan_intravoxel_atlas/fig1.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Intravoxel architecture atlases from birth to 100 years of age.
</div>
...
<div class="caption">
    White matter volume and FODF-based tissue anisotropy.
</div>
...
<div class="caption">
    Fiber orientation distribution functions within the brainstem at five time points. 
</div>
